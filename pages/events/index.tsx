...
const EventsPage = () => {
	return (
		<MainLayout>
			...
			<div className="mb-12 flex flex-col gap-2 md:mb-10 md:mt-6">
				{parties.map((data) => (
					<Link
						href={`events/${data.id}`}
						key={data.id}
						className="flex flex-col justify-between rounded-lg border-2 border-slate-300 p-2 hover:bg-slate-100 md:flex-row "
					>
