...
export type PublishEventMutation = {
	__typename?: 'Mutation';
	publishEvent?: { __typename?: 'Event'; id: string } | null;
};
...
export type GetAllEventsQuery = {
	...
	events: Array<{
		...
		stuffs: Array<{
			...
			id: string;
			name: string;
			type?: Stuff_Type | null;
		}>;
		image?: { __typename?: 'Asset'; id: string; url: string } | null;
	}>;
};

export type StuffDataFragment = {
	__typename?: 'Stuff';
	id: string;
	name: string;
	type?: Stuff_Type | null;
...
export type GetAllEventsQueryHookResult = ReturnType<
	typeof useGetAllEventsQuery
>;
export type GetAllEventsLazyQueryHookResult = ReturnType<
	typeof useGetAllEventsLazyQuery
>;
 ...
 * });
 */
export function useGetAllStuffQuery(
	baseOptions?: Apollo.QueryHookOptions<
		GetAllStuffQuery,
		GetAllStuffQueryVariables
	>
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<GetAllStuffQuery, GetAllStuffQueryVariables>(
		GetAllStuffDocument,
		options
	);
}
export function useGetAllStuffLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		GetAllStuffQuery,
		GetAllStuffQueryVariables
	>
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<GetAllStuffQuery, GetAllStuffQueryVariables>(
		GetAllStuffDocument,
		options
	);
}
export type GetAllStuffQueryHookResult = ReturnType<typeof useGetAllStuffQuery>;
export type GetAllStuffLazyQueryHookResult = ReturnType<
	typeof useGetAllStuffLazyQuery
>;
export type GetAllStuffQueryResult = Apollo.QueryResult<
	GetAllStuffQuery,
	GetAllStuffQueryVariables
>;
